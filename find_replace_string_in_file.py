...
# REPLACEMETN_STRING={'cdw-qa-8380:':'cdw-prod-6040.', 'fdw-qa-1054':'fdw-prod-5288.', 'odw-qa-3094':'odw-prod-4581.'}
...
def main():
    ...
    if file_changed_count > 0:
        print(f"print changed file count : {file_changed_count} and File name : {file_changed_count_list}")
    else :
