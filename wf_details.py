wf_details = {
    ...
    "KAIKU.wf_INVOICE_to_kaiku_stg": [
        "KAIKU_STG.STG_CARRY_OVER_INVOICES"
    ],
    ...
    "KAIKU.wf_device_to_kaiku_stg": [
        "KAIKU_STG.STG_SVOC_SOR_SOR_DEVICE_MODEL"
    ],
    ...
    "KAIKU.wf_enrich_sales_to_kaikustg": [
        "KAIKU_STG.STG_SVOC_STG_ST_EP_ENRICH",
        "KAIKU_STG.STG_SVOC_STG_ST_EP_ENRICH"
    ],
    "KAIKU.wf_fixed_base_to_kaiku_stg": [
        "KAIKU_STG.STG_SVOC_BUS_FCT_FIXED_BASE_T"
    ],
    "KAIKU.wf_initKaikuMeta": [
        "KAIKU_STG.C_CONTROL_MASTER",
        "/kaiku/parameters/kaikuparameterfile11.dat"
    ],
